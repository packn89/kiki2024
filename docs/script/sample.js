...
function makeMessage(index) {
    ...
    let firstSrc = "<div class='km_content'>" +
        "    <div class='km_icon' style='background-image: url(data/img/"  + name + ".jpg);'></div>" +
    ...
    $("#overlay").load("kiki_talk.html", function () {
        ...
        $.each(msgAry, function (index, value) {
            let kcontent = "<li class='kl_content' data-index='" + index +
                "'><div class='kl_icon' style='background-image: url(data/img/" + value[0] + ".jpg);'></div><div class='kl_data'><div class='kl_name klindex'>" +
